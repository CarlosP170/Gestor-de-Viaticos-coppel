...
public class HistorialViajesRHActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_historial_viajes_rh);
    ...
    private void cargarHistorialViajes() {
        ViajeDAO.obtenerViajesHistorialRH(new ViajeDAO.ViajeListCallback() {
            @Override
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    TextView sinHistorial = new TextView(HistorialViajesRHActivity.this);
                    LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                            LinearLayout.LayoutParams.MATCH_PARENT, 160);
                    params.setMargins(0, 60, 0, 60);
                    sinHistorial.setLayoutParams(params);

                    sinHistorial.setText("🔍 No hay historial de viajes revisados");
                    sinHistorial.setTextSize(18);
                    sinHistorial.setTextColor(ContextCompat.getColor(HistorialViajesRHActivity.this, android.R.color.black));
    ...
    private void regresarMenu() {
        try {
            Intent intent = new Intent(HistorialViajesRHActivity.this, SupervisionViajesActivity.class);
