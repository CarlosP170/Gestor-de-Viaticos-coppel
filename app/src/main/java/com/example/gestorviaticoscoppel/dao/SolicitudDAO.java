...
public class SolicitudDAO {
            ...
            protected List<Solicitud> doInBackground(Void... voids) {
                ...
                try (Connection conn = DatabaseConnection.getConnection()) {
                    ...
                    while (rs.next()) {
                        ...
                        solicitud.setMotivoRechazo(rs.getString("Motivo_Rechazo"));
    ...
    public static void rechazarSolicitudConMotivo(int idSolicitud, String idRevisor, String motivo, SolicitudCallback callback) {
        new AsyncTask<Void, Void, String>() {
            private String error;
            ...
            protected String doInBackground(Void... voids) {
                try (Connection conn = DatabaseConnection.getConnection()) {
                    ...
                    String query = "UPDATE Solicitudes_Viaticos SET Estado = 'Rechazada', " +
                            "ID_Revisor = ?, Fecha_Revision = GETDATE(), Motivo_Rechazo = ? WHERE ID_Solicitud = ?";
                    ...
                    int result = stmt.executeUpdate();
                    return result > 0 ? "Solicitud rechazada correctamente con motivo" : null;
