        ...
        new AsyncTask<Void, Void, List<Notificacion>>() {
            ...
            protected List<Notificacion> doInBackground(Void... voids) {
                ...
                try (Connection conn = DatabaseConnection.getConnection()) {
                    ...
                    error = e.getMessage();
                    Log.e(TAG, "Error obteniendo notificaciones: " + e.getMessage());
                    return null;
                }
            }
        ...
        new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... voids) {
                try (Connection conn = DatabaseConnection.getConnection()) {
                    ...
                    error = e.getMessage();
                    Log.e(TAG, "Error verificando notificaciones: " + e.getMessage());
                    return false;
                }
            }
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                try (Connection conn = DatabaseConnection.getConnection()) {
                    ...
                    error = e.getMessage();
                    Log.e(TAG, "Error marcando notificación: " + e.getMessage());
                    return null;
                }
            }
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                try (Connection conn = DatabaseConnection.getConnection()) {
                    ...
                    error = e.getMessage();
                    Log.e(TAG, "Error marcando todas las notificaciones: " + e.getMessage());
                    return null;
                }
            }
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                try (Connection conn = DatabaseConnection.getConnection()) {
                    ...
                    error = e.getMessage();
                    Log.e(TAG, "Error eliminando notificaciones antiguas: " + e.getMessage());
                    return null;
                }
            }
        ...
        new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... voids) {
                try (Connection conn = DatabaseConnection.getConnection()) {
                    ...
                    error = e.getMessage();
                    Log.e(TAG, "Error verificando solicitudes pendientes: " + e.getMessage());
                    return false;
                }
            }
        ...
        new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... voids) {
                try (Connection conn = DatabaseConnection.getConnection()) {
                    ...
                    error = e.getMessage();
                    Log.e(TAG, "Error verificando viajes pendientes: " + e.getMessage());
                    return false;
                }
            }
